...
@XmlRootElement(name = "reserveRoom", namespace = "http://server.soap.project/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "reserveRoom", namespace = "http://server.soap.project/", propOrder = {"arg0", "arg1", "arg2", "arg3"})
